...
class CRM_VoiceBroadcast_DAO_VoiceBroadcastMapping extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_voicebroadcast_mapping';
  /**
  ...
  {
    $this->__table = 'civicrm_voicebroadcast_mapping';
    parent::__construct();
  }
  /**
