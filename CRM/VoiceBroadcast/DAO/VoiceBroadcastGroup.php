...
class CRM_VoiceBroadcast_DAO_VoiceBroadcastGroup extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_voicebroadcast_group';
  /**
  ...
  {
    $this->__table = 'civicrm_voicebroadcast_group';
    parent::__construct();
  }
  /**
