...
class CRM_VoiceBroadcast_DAO_VoiceBroadcastJob extends CRM_Core_DAO
{
  /**
   ...
   * @static
   */
  static $_tableName = 'civicrm_voicebroadcast_job';
  /**
  ...
  {
    $this->__table = 'civicrm_voicebroadcast_job';
    parent::__construct();
  }
  /**
  ...
  static function getReferenceColumns()
  {
    if (!self::$_links) {
      ...
      self::$_links[] = new CRM_Core_Reference_Basic(self::getTableName() , 'parent_id', 'civicrm_voicebroadcast_job', 'id');
    }
    return self::$_links;
  }
  /**
    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        ...
        'parent_id' => array(
          ...
          'type' => CRM_Utils_Type::T_INT,
          'default' => 'NULL',
          'FKClassName' => 'CRM_VoiceBroadcast_DAO_VoiceBroadcastJob',
        ) ,
        'job_offset' => array(
          'name' => 'job_offset',
          'type' => CRM_Utils_Type::T_INT,
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['voicebroadcast_job'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['voicebroadcast_job'] = & $fields[$name];
          } else {
